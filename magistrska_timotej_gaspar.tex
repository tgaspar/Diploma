...
\subsection{Vodenje v zunajih koordinatah}
...
Zgrajen je bil program v programskem okolju \matlab \simulink, ki deluje s frekvenco 500 Hz in pošilja ukaze o željenih navorov po UDP protokolu na strežnik opisan v poglavju \ref{arc_drive}.
