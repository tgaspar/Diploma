...
Zaganjanje ter uporaba strežnika je opisana v dodatku \ref{appendix:udp-arcnet-server}.
...
Robot brez prijemala v praksi ni pretirano uporaben saj lahko opravlja le malo kolièino nalog. Recimo premikanje objektov s porivanjem. V kolikor pa želimo, da bo robot lahko izvajal tudi druge naloge, je potrebno nanj pritrditi primerno prijemalo. Ker pa imamo mi na vrhu robota najprej senzor, pomeni, da omenjeno prijemalo pritrdimo na senzor. Ker ima prijemalo svoje maso, bo na senzor delovala neka sila kot posledica delovanja gravitacije. Kar pomeni, da bomo kljub temu, da senzor ni v kontaktu z okolico, merili neke sile. To pa ni dobrodošlo, saj mi želimo meriti le sile, ki se dogajajo v kontaktu z okolico, prijemalo je namreè del robota. 

Avtorji v \cite{nemec-jr3}  predlagajo metodo za kompenzacijo vpliva gravitacije na senzor sile. 
...
\end{equation}
Primer odziva takega regulatorja je na sliki \ref{fig:p-reg}.
